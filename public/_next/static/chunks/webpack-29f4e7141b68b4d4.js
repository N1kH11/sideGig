! function() {
    ...
    g.m = e, a = [], g.O = function(b, c, d, e) {
        ...
        for (var h = 1 / 0, f = 0; f < a.length; f++) {
            for (var c = a[f][0], d = a[f][1], e = a[f][2], i = !0, j = 0; j < c.length; j++) h >= e && Object.keys(g.O).every(function(a) {
                return g.O[a](c[j])
            }) ? c.splice(j--, 1) : (i = !1, e < h && (h = e));
            if (i) {
                a.splice(f--, 1);
                var k = d();
                void 0 !== k && (b = k)
        ...
        for (var c in b) g.o(b, c) && !g.o(a, c) && Object.defineProperty(a, c, {
            enumerable: !0,
            get: b[c]
        })
    }, g.g = (function() {
        ...
        for (a && a(c); j < f.length; j++) e = f[j], g.o(b, e) && b[e] && b[e][0](), b[f[j]] = 0;
        return g.O(k)
